...
[SuppressMessage("Performance", "CA1812:Avoid uninstantiated internal classes", Justification = "Instantiated by BoardAgentFactory")]
internal sealed class SharedStateAgent : DelegatingAIAgent
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        firstRunOptions.ChatOptions.ResponseFormat = ChatResponseFormat.ForJsonSchema<BoardStateSnapshot>(
            schemaName: "BoardStateSnapshot",
            schemaDescription: "A response containing the current board state with all issues");
